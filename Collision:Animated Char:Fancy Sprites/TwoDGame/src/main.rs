        ...
        engine.sprites.add_sprite_group(
            ...
            vec![
                ...
                GPUSprite {
                    ...
                    sheet_region: [16.0 / 72.0, 16.0 / 88.0, 8.0 / 72.0, 8.0 / 88.0],
                },
                GPUSprite {
                    //L
                ...
                GPUSprite {
                    //A
                    screen_region: [starting_x + (34.0 * 7.0), y_val, 32.0, 32.0],
                    sheet_region: [0.0 / 72.0, 0.0 / 88.0, 8.0 / 72.0, 8.0 / 88.0],
                },
                GPUSprite {
                    //Y
                    screen_region: [starting_x + (34.0 * 8.0), y_val, 32.0, 32.0],
                    sheet_region: [48.0 / 72.0, 16.0 / 88.0, 8.0 / 72.0, 8.0 / 88.0],
                },
                GPUSprite {
                    //E
                    screen_region: [starting_x + (34.0 * 9.0), y_val, 32.0, 32.0],
                    sheet_region: [32.0 / 72.0, 0.0 / 88.0, 8.0 / 72.0, 8.0 / 88.0],
                },
                GPUSprite {
                    //R
                    screen_region: [starting_x + (34.0 * 10.0), y_val, 32.0, 32.0],
                    sheet_region: [64.0 / 72.0, 8.0 / 88.0, 8.0 / 72.0, 8.0 / 88.0],
                },
            ],
            self.camera,
        ...
        engine.sprites.add_sprite_group(
            ...
            vec![
                ...
                GPUSprite {
                    //G
                    screen_region: [starting_x + (34.0 * 3.0), y_val, 32.0, 32.0],
                    sheet_region: [48.0 / 72.0, 0.0 / 88.0, 8.0 / 72.0, 8.0 / 88.0],
                },
                GPUSprite {
                    //L
                    screen_region: [starting_x + (34.0 * 4.0), y_val, 32.0, 32.0],
                ...
                GPUSprite {
                    //R
                    screen_region: [starting_x + (34.0 * 11.0), y_val, 32.0, 32.0],
                    sheet_region: [64.0 / 72.0, 8.0 / 88.0, 8.0 / 72.0, 8.0 / 88.0],
                },
            ],
            self.camera,
